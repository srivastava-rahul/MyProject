			...
			init 	: function( options ) {
				...
				if( this.length ) {
					...
					var settings = {
						...
						animMouseenter		: {
							'mText' : {speed : 250, easing : 'easeOutExpo', delay : 140, dir : 1},
							'icon'  : {speed : 250, easing : 'easeOutExpo', delay : 280, dir : 1}
						},
					...
					return this.each(function() {
						...
						$menuItems.find('.menu-item').each(function() {
							var $el	= $(this);
						...
						$menuItems.bind('mouseenter', function(e) {
							...
							var $item		= $(this),
								...
								$movingItems= $wrapper.find('.menu-item'),
